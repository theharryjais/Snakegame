...
bgn = pygame.image.load("Snakes.jpg")

bgimg = pygame.transform.scale(bgimg,(WINDOW_WIDTH,WINDOW_HEIGHT))
bg= pygame.transform.scale(bg,(WINDOW_WIDTH,WINDOW_HEIGHT))
bgn = pygame.transform.scale(bgn,(WINDOW_WIDTH,WINDOW_HEIGHT))
...
def start_game():
    ...
    start_font5 = medium_font.render("Developer", True, RED, YELLOW)
...
def creator():
    ...
    start_inst1 = large_font.render("Harry Jaiswal", False, GREEN)
    start_inst1_rect = start_inst1.get_rect()
    start_inst1_rect.center = (WINDOW_WIDTH/2, 420)
    canvas.blit(start_inst1, start_inst1_rect)

    start_inst2 = small_font.render("Hello Everyone,It's me Harry Jaiswal.", True, RED)
    start_inst3 = small_font.render("My student id is 210264.", True, BLUE)
    start_inst4 = small_font.render("This is a very simple game, developed using by python", True,GREEN)
    start_inst5 = small_font.render("Thanks for playing my game", True, YELLOW)
    start_inst6 = small_font.render("In case of queries, contact  to harryjaiswal2077@gmail.com", True, RED)
